...
const skirrtt = document.getElementById("dice");
...
function hold(e) {
    if (turn == 1) {
        player1Total.innerHTML =
            parseInt(player1Total.innerHTML) +
            parseInt(player1Current.innerHTML);
        player1Current.innerHTML = 0;
    } else {
        player2Total.innerHTML =
            parseInt(player2Total.innerHTML) +
            parseInt(player2Current.innerHTML);
        player2Current.innerHTML = 0;
    }
    checkForWinner();
    if (gameNotOver) {
